...
function CreateAgentDialog2({setAgent, setCreateAgent, agent, setAopen}:DialogProps){
  ...
  return (
    <div className="fixed inset-0 bg-black/40 justify-center items-center flex z-100">
      <div className="flex flex-col bg-white w-[95%] rounded-2xl max-h-[98vh] px-8 pb-5 pt-10 overflow-auto relative sm:w-180 sm:max-h-[90vh]">
        ...
        <div className="flex">
          <button onClick={()=>createHandler()} disabled={checkValid()} className="border-2 px-8 ml-auto py-1.5 rounded-3xl bg-black text-white hover:bg-gray-800 active:bg-gray-700 disabled:bg-gray-400 sm:bg-blue-500 sm:hover:bg-blue-600 sm:active:bg-blue-700">Create</button>
        </div>
...
export default CreateAgentDialog2;