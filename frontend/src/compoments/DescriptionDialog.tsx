...
function DescriptionDialog({setDes, description, setDescription}:DescriptionDialogProps){
  return (
    <div className="fixed inset-0 bg-black/40 justify-center items-center flex">
      <div className="flex flex-col bg-white w-[95%] rounded-2xl mt-13 h-[80vh] px-8 pb-5 pt-14 overflow-auto relative sm:w-180">
        ...
        <textarea className="w-full bg-gray-100 flex-1 rounded-xl px-2 py-2 text-lg" value={description} onChange={(event)=>setDescription(event.target.value)} />
