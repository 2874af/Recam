...
function MenuDialog({setMenu, choice, onClick, photo, video, floor, vr, setEdit, sections}:MenuDialogProps){
  return (
    <div className="fixed inset-0 bg-black/40 flex z-100">
      <div className="h-full w-50 bg-white flex flex-col items-center py-7 gap-2">
        <button onClick={()=>{
          setEdit(true);
          setMenu(false);
        }} className="bg-black text-white flex items-center justify-center rounded-2xl py-2 gap-1 w-30 text-xs hover:bg-gray-700 active:bg-gray-500">
